...
namespace Khendys.Controls
{
	...
	// Перечисление возможных цветов RTF
	...
	/// <summary>
	/// Этот класс добавляет в RichTextBox следующие функциональные возможности:
	/// 
	/// 1.	Позволяет программно вставлять или добавлять обычный текст в формат RTF
	///		контент.
	/// 2.	Позволяет использовать шрифт, цвет текста и цвет выделения обычного текста
	///		указывающийся при вставке или добавлении текста в формате RTF.
	///	3.	Позволяет вставлять изображения программно или при взаимодействии с
	///		пользователем.
	/// </summary>
	/// <remarks>
	/// Множество решений проблемы программной вставки изображений
	/// в RichTextBox используйте буфер обмена или жесткий код RTF для
	/// изображение в программе. Этот класс представляет собой попытку сделать процесс
	/// вставки изображений во время выполнения более гибкая без дополнительных затрат на обслуживание
	/// буфер обмена или использование огромных, громоздких строк.
	/// 
	/// Спецификация RTF v1.6 использовалась и упоминается много раз в этом документе.
	/// http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnrtfspec/html/rtfspec.asp
	/// 
	/// Для получения информации о RichEdit (Неуправляемый RichTextBox)...
	...
	public class ExRichTextBox : System.Windows.Forms.RichTextBox
	{
		...
		// Задает флаги/параметры для неуправляемого вызова метода GDI+
		// Metafile.EmfToWmfBits().
		private enum EmfToWmfBitsFlags
		{

			// Используйте преобразование по умолчанию
			EmfToWmfBitsFlagsDefault = 0x00000000,

			// Встроил источник метафайла EMF в результирующий WMF
			// метафайл
			EmfToWmfBitsFlagsEmbedEmf = 0x00000001,

			// Поместите 22-байтовый заголовок в результирующий WMF-файл. Заголовок является
			// требуется для того, чтобы метафайл считался размещаемым.
			EmfToWmfBitsFlagsIncludePlaceable = 0x00000002,

			// Не имитируйте отсечение с помощью оператора ИСКЛЮЧАЮЩЕЕ ИЛИ.
